          ...
          <div className="top-0 z-10 bg-white border-b border-gray-200 px-8 py-6 flex items-center justify-between rounded-t-2xl">
            <div>
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`px-4 py-1 rounded-full text-sm font-semibold ${bay.status === "Free"
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-xl p-6 space-y-3">
                {bay.recentActivity.map((activity, index) => (
                  ...
                  >
                    <div
                      className={`w-2 h-2 rounded-full ${activity.type === "Entry"
                          ? "bg-emerald-600"
                          : "bg-blue-600"
                        }`}
                    />
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${activity.type === "Entry"
                          ? "bg-emerald-100 text-emerald-700"
                    ...
                    {bay.recentVehicles.map((vehicle, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-semibold ${vehicle.direction === "Entry"
                                ? "bg-emerald-100 text-emerald-700"
                                : "bg-blue-100 text-blue-700"
                              }`}
                          >
              ...
              <div>
                ...
                <div className="space-y-3">
                  {bay.alerts.map((alert, index) => (
                    <div
                      key={index}
                      className={`flex gap-4 p-4 rounded-xl border ${alert.type === "reminder"
                    ...
                    >
                      ...
                      <div>
                        <span
                          className={`inline-block px-3 py-1 mb-2 rounded-full text-xs font-bold ${alert.type === "reminder"
            ...
            <div className="flex gap-2 bg-gray-100 p-1 rounded-lg">
              {['Today', 'This week', 'This month'].map((view) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeView === view.toLowerCase().replace(' ', '-')
              ...
              >
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-4 py-1 rounded-full text-sm font-bold ${bay.status === 'Free'
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <div className={`flex items-center gap-2 ${bay.performance === 'high' ? 'text-emerald-600' :
                ...
                <tbody className="divide-y divide-gray-200">
                  {recentBayActivity.map((activity, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${activity.direction === 'Entry'
                            ? 'bg-emerald-100 text-emerald-700'
                            : 'bg-blue-100 text-blue-700'
                          }`}>
                          {activity.direction}
